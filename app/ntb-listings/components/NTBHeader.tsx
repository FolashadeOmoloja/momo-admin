  ...
  return (
    <div className="flex items-center justify-between w-full py-4 px-0">
      ...
      <button
        ...
        className="bg-[#004F71] hover:bg-[#003B54] text-white px-4 py-2 rounded-lg font-semibolds  flex items-center gap-2 shadow-sm"
      >
        Add New NTBs <HiChevronDown className="w-4 h-4" />
      </button>

      {isOpen && (
        <div className="absolute right-[35px] top-[120px] z-10 mt-2 w-60 bg-white rounded-lg shadow-lg border border-gray-200">
          <button
            onClick={() => {
              setIsOpen(false);
